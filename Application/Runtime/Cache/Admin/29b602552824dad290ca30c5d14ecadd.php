                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>订单退款列表</div>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    <form method="post" action="/index.php/Admin/Orders/Refund" id="form">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX" id="list<?php echo ($vo["id"]); ?>">
                                            ...
                                            <td>
                                                <?php if($vo["status"] == 4): ?><span class="label label-warning">待退款</span>
                                                <?php elseif($vo["status"] == 5): ?>
                                                <span class="label label-success">已退款</span><?php endif; ?>
                                            </td>
                                            <td class="">
                                              <a href="/index.php/Admin/Orders/Info?id=<?php echo ($vo["id"]); ?>">查看</a>
                                               <?php if($vo["status"] == 4): ?><a href="#" onclick="complete(<?php echo ($vo["id"]); ?>)">完成</a><?php endif; ?>
                                            </td>
...
function complete(id){
    yyxcomfirm(function(){
        yyxajax("/index.php/Admin/Orders/Rsuccess",{"id":id},function(ret){
                        if(ret==1){
                                alert('操作成功，订单完成！');
                                self.location="/index.php/Admin/Orders/Refund";
                        }else{
                            yyxalert('网络繁忙！');
                        }
