                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    <form method="post" action="/index.php/Admin/Orders/Gift" id="form">
                                        <div class=" pull-right">
                                                <label id="soid">搜索: <input type="text" aria-controls="sample_1" class="m-wrap medium" name="so" value="<?php echo ($so); ?>"></label>
                                        </div>
                                    </form>
                                </div>
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX" id="list<?php echo ($vo["id"]); ?>">
                                            ...
                                            <td><?php echo ($vo["cent"]); ?></td>
                                            <td><?php echo ($vo["title"]); ?></td>
                                            <td><?php echo ($vo["g_address"]); ?></td>
                                            <td><?php echo ($vo["g_tel"]); ?></td>
                                            <td><?php echo ($vo["classname"]); ?></td>
                                            <td><?php echo (date("Y-m-d H:s:i",$vo["add_time"])); ?></td>
                                            <td><?php echo ($vo["p_name"]); ?></td>
                                            <td>
                                                <?php if($vo["status"] == 0): ?><span class="label label-fail">未完成</span>
                                            ...
                                            <td class="peisong">
                                               <a href="/index.php/Admin/Orders/Giftinfo?id=<?php echo ($vo["id"]); ?>">查看</a>
                                            <div>
                                               <?php if($vo["status"] == 0): ?><span>选择配送员</span>
                                                   <select class="small m-wrap" data-val="<?php echo ($vo["id"]); ?>" tabindex="1" id="id_ps<?php echo ($vo["id"]); ?>">
                                                     <?php if(is_array($p)): foreach($p as $key=>$vo1): ?><option value="<?php echo ($vo1["id"]); ?>"><?php echo ($vo1["name"]); ?></option><?php endforeach; endif; ?>
                                                   </select>
                                                   <span onclick="qdps('id_ps<?php echo ($vo["id"]); ?>')"><a href="#">确定</a></span>
                                               <?php else: ?>
                                                    <?php if($vo["status"] == 1): ?><a href="#" onclick="complete(<?php echo ($vo["id"]); ?>)">完成</a><?php endif; endif; ?>
                                             </div>
                                            </td>
...
function qdps(name){
    ...
    yyxcomfirm(function(){
        yyxajax("/index.php/Admin/Orders/gitfcheck_P",{"o_id":$("#"+name).data("val"),"p_id":$("#"+name+" option:selected").val()},function(ret){
                        if(ret==1){
                                alert('选择成功！');
                                self.location="/index.php/Admin/Orders/Gift";
                        }else{
                            yyxalert('网络繁忙！');
                        }
...
function complete(id){
    yyxcomfirm(function(){
        yyxajax("/index.php/Admin/Orders/Giftcomplete",{"id":id},function(ret){
                        if(ret==1){
                                alert('操作成功，订单完成！');
                                self.location="/index.php/Admin/Orders/Gift";
                        }else{
