                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <form method="post" action="/index.php/Admin/Orders/F_order" id="form">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX" id="list<?php echo ($vo["id"]); ?>">
                                            ...
                                            <td class="peisong">
                                              ...
                                              <a onclick="del(<?php echo ($vo["id"]); ?>)">取消订单</a>
                                            <div>
                                               <?php if(($vo["status"] == 1) OR($vo["status"] == 6)): ?><span>选择配送员</span>
                                                   ...
                                                   <span onclick="qdps('id_ps<?php echo ($vo["id"]); ?>')"><a href="#">确定</a></span><?php endif; ?>
                                            </div>
                                            </td>
...
function qdps(name){
    ...
    yyxcomfirm(function(){
        ...
        yyxajax("/index.php/Admin/Orders/check_P",{"o_id":$("#"+name).data("val"),"p_id":$("#"+name+" option:selected").val()},function(ret){

                        if(ret==1){

                                alert('选择成功，请到订单列表查看详情！');

                                self.location="/index.php/Admin/Orders/F_order";
...
function del(id){
    yyxcomfirm(function(){
        yyxajax("/index.php/Admin/Orders/del",{"id":id},function(ret){
                        if(ret==1){
                                self.location="/index.php/Admin/Orders/F_order";
                        }else{
                            yyxalert('网络繁忙！');
