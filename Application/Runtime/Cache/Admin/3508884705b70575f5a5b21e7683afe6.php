					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>配送员列表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									<form method="post" action="/index.php/Admin/Shopper/Index" id="form">
										<div class="btn-group">

											<a id="sample_editable_1_new" class="btn green" onclick="go2info()">

										新建配送员<i class="icon-plus"></i>

											</a>

										</div>
										<div class=" pull-right">
												<label id="soid">搜索: <input type="text" placeholder="请输入姓名或电话号码！" aria-controls="sample_1" class="m-wrap medium" name="so" value="<?php echo ($so); ?>"></label>
										</div>
									</form>
								</div>
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX" id="list<?php echo ($vo["id"]); ?>">
											<td class="hidden-480 hyxid"><a href="/index.php/Admin/Shopper/Info?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["id"]); ?></a></td>
...
function del(id){
	yyxcomfirm(function(){
		yyxajax("/index.php/Admin/Shopper/del",{"id":id},function(ret){
						if(ret==1){
								self.location="/index.php/Admin/Shopper/Index";
						}else{
							yyxalert('网络繁忙！');
						}
